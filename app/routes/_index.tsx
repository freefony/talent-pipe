...
import { FilterApplicationsBySources } from "./components/filters/by-sources";
...
export function loader({ request }: LoaderFunctionArgs) {
  ...
  return { data: getApplicationAnalysis({ byDate: { from, to }, byLevel: level, bySource: source }) }
}
